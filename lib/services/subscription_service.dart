...
class SubscriptionService {
  ...
  static String get _androidKey =>
      ...
      'goog_yTGrCFLGYSwwEJkapVcmHHkZYxG';
  static String get _iosKey =>
      dotenv.env['REVENUECAT_IOS_KEY'] ?? 'test_dqUqZKVCRZxyjcGymsxZQGRxHJf';
  ...
  void _onCustomerInfoUpdated(CustomerInfo customerInfo) async {
    final hasPro =
        customerInfo.entitlements.active.containsKey('TheStatic Pro') ||
  ...
  Future<bool> canPlayConfession() async {
    return true; // No premium subscription restriction
  }

  Future<void> incrementDailyPlaybackCount() async {
    // Do nothing as limits are removed
  }
